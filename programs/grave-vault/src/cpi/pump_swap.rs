...
//
// PumpSwap — honest-stub adapter for m5.
//
// PRE-MAINNET-TODO(CPI): Implement the real PumpSwap `remove_liquidity`
...
// PumpSwap pool gets an explicit, named error.
//
// See `docs/PRE_MAINNET_CHECKLIST.md` entry `CPI-008`.
