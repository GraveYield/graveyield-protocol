...
//
// Orca Whirlpool — honest-stub adapter for m5.
//
// PRE-MAINNET-TODO(CPI): Implement the real Orca Whirlpool `remove_liquidity`
...
// Orca Whirlpool pool gets an explicit, named error.
//
// See `docs/PRE_MAINNET_CHECKLIST.md` entry `CPI-007`.
